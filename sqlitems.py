...
mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567890'")
CarltonCost = mycursor.fetchone()
for row in CarltonCost:
    global CarltonSchCost
    CarltonSchCost = row;

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567889'")
TooheysCost = mycursor.fetchone()
for row in TooheysCost:
    global TooheysSchCost
    TooheysSchCost = row;    

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567888'")
XXXXCost = mycursor.fetchone()
for row in XXXXCost:
    global XXXXSchCost
    XXXXSchCost = row;

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567887'")
FurphyCost = mycursor.fetchone()
for row in FurphyCost:
    global FurphySchCost
    FurphySchCost = row;

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567886'")
KosciuszkoCost = mycursor.fetchone()
for row in KosciuszkoCost:
    global KosciuszkoSchCost
    KosciuszkoSchCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567885'")
...
mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567884'")
BottleOfRoséCost = mycursor.fetchone()
for row in BottleOfRoséCost:
    global RoséBottleCost
    RoséBottleCost = row;    

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567883'")
GlassOfChardonnayCost = mycursor.fetchone()
for row in GlassOfChardonnayCost:
    global ChardonnayGlassCost
    ChardonnayGlassCost = row;    

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567882'")
...
mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567881'")
GlassOfShirazCost = mycursor.fetchone()
for row in GlassOfShirazCost:
    global ShirazGlassCost
    ShirazGlassCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567880'")
BottleOfShirazCost = mycursor.fetchone()
for row in BottleOfShirazCost:
    global ShirazBottleCost
    ShirazBottleCost = row;  

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567879'")
NipOfBundabergCost = mycursor.fetchone()
for row in NipOfBundabergCost:
    global BundabergNipCost
    BundabergNipCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567878'")
NipOfGeorgeDickelCost = mycursor.fetchone()
for row in NipOfGeorgeDickelCost:
    global GeorgeDickelNipCost
    GeorgeDickelNipCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567877'")
NipOfSmirnoffCost = mycursor.fetchone()
for row in NipOfSmirnoffCost:
    global SmirnoffNipCost
    SmirnoffNipCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567876'")
NipOfGoronsCost = mycursor.fetchone()
for row in NipOfGoronsCost:
    global GordonsNipCost
    GordonsNipCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567875'")
...
mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567874'")
...
mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567873'")
MargaritaCost = mycursor.fetchone()
for row in MargaritaCost:
    global MargCost
    MargCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567872'")
CosmopolitanCost = mycursor.fetchone()
for row in CosmopolitanCost:
    global CosmoCost
    CosmoCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567871'")
MojitoCost = mycursor.fetchone()
for row in MojitoCost:
    global MojitoCocCost
    MojitoCocCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567870'")
OldFashionedCost = mycursor.fetchone()
for row in OldFashionedCost:
    global OldFashionedCostCocCost
    OldFashionedCocCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567869'")
NegroniCost = mycursor.fetchone()
for row in NegroniCost:
    global NegroniCocCost
    NegroniCocCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567868'")
EspressoMartiniCost = mycursor.fetchone()
for row in EspressoMartiniCost:
    global EspressoCost
    EspressoCost = row; 

mycursor.execute("SELECT Product_Per_Unit_Cost FROM ProductItems WHERE Product_ID = '1234567867'")
JugOfBeerCost = mycursor.fetchone()
for row in JugOfBeerCost:
    global BeerJugCost
    BeerJugCost = row; 
...
class POS:
    ...
    def __init__(self,root):
        ...
        def VB():   
            ItemCost = 2.3 
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("VB Schooner", "1", VBSchCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def Carlton():  
            ItemCost = 1.9
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Carlton Schooner", "1", CarltonSchCost))            
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def Tooheys():   
            ItemCost = 1.70
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Tooheys New Schooner", "1", TooheysSchCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def XXXX():  
            ItemCost = 0.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("XXXX Gold Schooner", "1", XXXXSchCost))
        ...
        def Furphy():   
            ItemCost = 3.95
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Furphy Schooner", "1", FurphySchCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def Kosciuszko():  
            ItemCost = 3.75
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Kosciuszko Schooner", "1", KosciuszkoSchCost))
        ...
        def Rose():   
            ItemCost = 1.20
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Bottle of Rosé", "1", RoséBottleCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def Champagne():  
            ItemCost = 1.10
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Bottle of Champagne", "1", ChampagneBottleCost))
        ...
        def WhiteGlass():   
            ItemCost = 1.20
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Shiraz Glass", "1", ChardonnayGlassCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
                SubTotal_Input.set(str('$%.2f'%(ItemCost-1.20)))
                Tax_Input.set(str('$%.2f'%(((ItemCost-1.20)* Tax)/100))) 
        ...
        def WhiteBottle():  
            ItemCost = 2.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Shiraz Bottle", "1", ChardonnayBottleCost))
        ...
        def RedGlass():   
            ItemCost = 3.20
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Chardonnay Glass", "1", ShirazGlassCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def RedBottle():  
            ItemCost = 1.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Chardonnay Bottle", "1", ShirazBottleCost))
        ...
        def Bundaberg():   
            ItemCost = 2.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Bunadberg OP Nip", "1", BundabergNipCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
                SubTotal_Input.set(str('$%.2f'%(ItemCost-2.90)))
                Tax_Input.set(str('$%.2f'%(((ItemCost-2.90)* Tax)/100))) 
        ...
        def GeorgeDickel():  
            ItemCost = 2.20
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Geroge Dickel Nip", "1", GeorgeDickelNipCost))
        ...
        def Smirnoff():   
            ItemCost = 2.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Smirnoff Nip", "1", SmirnoffNipCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
                SubTotal_Input.set(str('$%.2f'%(ItemCost-2.90)))
                Tax_Input.set(str('$%.2f'%(((ItemCost-2.90)* Tax)/100))) 
        ...
        def Gordons():  
            ItemCost = 2.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Gordons Nip", "1", GordonsNipCost))
        ...
        def DonJulioBlanco():   
            ItemCost = 3.20
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Don Julio Blanco Nip", "1", DonJulioBlancoNipCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
                SubTotal_Input.set(str('$%.2f'%(ItemCost-3.20)))
                Tax_Input.set(str('$%.2f'%(((ItemCost-3.20)* Tax)/100))) 
        ...
        def JohnnieWalkerRed():  
            ItemCost = 1.90
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Johnnie Walker Red Nip", "1", JohnnieWalkerRedNipCost))
        ...
        def Margarita():   
            ItemCost = 2.10
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Margarita", "1", MargCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def Cosmopolitan():  
            ItemCost = 2.75
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Cosmopolitan", "1", CosmoCost))
        ...
        def Mojito():   
            ItemCost = 1.59
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Mojito", "1", MojitoCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def OldFashioned():  
            ItemCost = 2.99
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Old Fashioned", "1", OldFashionedCocCost))
        ...
        def Negroni():   
            ItemCost = 3.40
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Negroni", "1", NegroniCocCost))
            for child in self.POS_records.get_children():
                ItemCost += float(self.POS_records.item(child, "values")[2])
        ...
        def EspressoMartini():  
            ItemCost = 2.89
            Tax = 2.5
            self.POS_records.insert("", tk.END, values=("Espresso Martini", "1", EspressoCost))
